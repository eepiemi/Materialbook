...
import com.eepiemi.materialbook.ui.components.sheet.MaterialbookSheet
...
import com.eepiemi.materialbook.utils.jsBridge.NavigateFB
...
fun BaseWebView(
    ...
    // Navigate to Materialbook on fb logo pressed from messenger.
    ...
    if (settingsToggle.value) MaterialbookSheet(viewModel, settingsToggle, onRestart)
    // A possible overkill to fix https://github.com/eepiemi/Materialbook/issues/5
    ...
    key(if (isAutoDesktop() || viewModel.isRevertDesktop.value) userAgent else null) {
        WebView(
            ...
            onCreated = { webView ->
                ...
                webView.apply {
                    addJavascriptInterface(MaterialbookSettings(settingsToggle), "SettingsBridge")
